...
<div class="text-center rounded p-4">
    <div style="text-align: right;" class="p-4">
        <h5>{{ date('d F Y') }}</h5>
        <div class="mb-3">
            <label for="tableSelection" class="form-label">Pilih Tabel untuk Dicetak:</label>
            <select class="form-select" id="tableSelection">
                <option value="transaksi">Tabel Transaksi</option>
                <option value="stok">Tabel Stok</option>
                <option value="both">Keduanya</option>
            </select>
            <button class="btn btn-primary mt-2" onclick="printTable()">Cetak Tabel</button>
        </div>
    </div>
