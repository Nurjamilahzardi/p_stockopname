      ...
      <div class="card-body">
        ...
        <p class="card-text">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="datetime-local" class="form-control datepicker-date @error('tanggaltransmasuk') is-invalid @enderror" id="tanggaltransmasuk" name="tanggaltransmasuk" value="Input Tanggal">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="slcupmasuk" class="col-sm-2 col-form-label ">UP</label>
                    <div class="col-sm-10">
                        <select class="form-select text-dark @error('slcupmasuk') is-invalid @enderror" id="slcupmasuk" name="slcupmasuk">
            ...
            <div class="mb-3 row">
                <label for="slculpmasuk" class="col-sm-2 col-form-label ">ULP</label>
                    <div class="col-sm-10">
                        <select class="form-select text-dark @error('slculpmasuk') is-invalid @enderror" id="slculpmasuk" name="slculpmasuk">
                            <option disabled selected>Pilih Opsi</option>
                            <option></option>  
                            @foreach($ULPs as $ulp)
