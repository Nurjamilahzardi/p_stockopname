                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <form action="/transaksi/{{$transaksi->id}}" class="d-inline" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn btn-danger me-2" type="submit" onclick="return confirm('Yakin akan Mendelete Data?')">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                </form>
                                                @if ($transaksi->trans_jenis == 'Masuk')
                                                    <a href="{{ route('cetak-barang-masuk', $transaksi->id)}}" class="btn btn-success"><i class="fa fa-print"></i></a>
                                                @elseif ($transaksi->trans_jenis == 'Keluar')
                                                    <a href="{{ route('cetak-barang-keluar', $transaksi->id)}}" class="btn btn-success"><i class="fa fa-print"></i></a>
                                                @endif
