                    ...
                    @if(Auth::check() && Auth::user()->role == 'admin')
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent show border-0 " aria-labelledby="transaksiDropdown">
                                <a href="/transaksi" class="dropdown-item nav-link @yield('Transaksi')"><i class="fa fa-credit-card-alt me-2"></i>Transaksi</a>
                                <a href="/report" class="dropdown-item nav-link @yield('Report')"><i class="fa fa-file me-2"></i>Report</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent show border-0 " aria-labelledby="dataMasterDropdown">
                                ...
                                <div class="nav-item dropdown">
                                    <a href="#" id="upDropdown" class="nav-link dropdown-toggle fs-6 text-black" data-bs-toggle="dropdown" aria-expanded="true">
                                        <i class="fa fa-building me-2"></i>Data UP</a>
                                        <div class="dropdown-menu ms-3 bg-transparent border-0" aria-labelledby="upDropdown">
                                            <a href="{{url('/up-informasi')}}" class="dropdown-item nav-link @yield('UP')">
                                                Informasi</a>
